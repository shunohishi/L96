...
set output=lpf-ens-inf.ps
set size=8/8l
set range=4/9/1e-3/1e0
set BA=a1:"Ensemble\040size":/a1:"Additive\040inflation\040factor\040Q":WSne
...
gawk '{if($4 == 1) print log($1)/log(2),$3,$11 > "dat.20"}' ${input}
