...
set size=12/12
set range=1/40/1/1.1
set BA=a10f1:"Number\040of\040Obs.":/a0.1f0.02:"Inflation\040factor":WSne
...
gawk '{if($9 != 0.) print $1,$2,$9 > "dat.20"}' ${input}
...
grdcontour dat.grd -JX -R -Ccontour1.cpt -W2 -A- -K -O >> ${output}
grdcontour dat.grd -JX -R -Ccontour2.cpt -W4 -A+a0+gwhite -K -O >> ${output}
psmask -C -K -O >> ${output}
